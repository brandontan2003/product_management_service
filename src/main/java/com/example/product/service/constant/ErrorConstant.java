package com.example.product.service.constant;

public class ErrorConstant {

    public static final String PRODUCT_NAME_EMPTY_ERROR = "Product name cannot be empty";
    public static final String PRODUCT_ID_EMPTY_ERROR = "Product Id cannot be empty";
    public static final String INVALID_PRODUCT_ID_ERROR = "Product Id is invalid";
